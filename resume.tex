...
%%% Essentials
\name{Mehdi}{Chamouma}
\address{Résidence le grand Chêne appt 14, 1278 route de Ganges, 34090 Montpellier}
\mobile{(+33) 06-58-69-29-16} 
%%% Social
\email{mehdi.chamouma@gmail.com}
\github{mehdichamouma}
\linkedin{mehdichamouma}
\driverlicence{Permis B}
\nationality{French nationality}
%%% Optionals
\position{Looking for a software engineer internship}
